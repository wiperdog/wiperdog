...
public class StackTraceUtils2 {
  ...
  public static void addClassTest(Closure classFilter)
  {
    ...
    public static Throwable sanitizeRootCause(Throwable t) {
        return StackTraceUtils2.sanitize(StackTraceUtils2.extractRootCause(t));
    }
    ...
    public static Throwable deepSanitize(Throwable t) {
        ...
        while (current.getCause() != null) {
            current = StackTraceUtils2.sanitize(current.getCause());
        }
        return StackTraceUtils2.sanitize(t);
    }
}
