...
PAUSE
%PARENT%\bin\groovy.bat -DWIPERDOG_HOME=%PARENT% --classpath %PARENT%\lib\java\bundle.a %PARENT%\installer\uninstall.groovy %uninstall_service% %delete_data% %delete_files%